...
PacketRecordDescriptor::PacketRecordDescriptor() : omnetpp::cClassDescriptor("PacketRecord", "omnetpp::cPacket")
{
...
std::string PacketRecordDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    PacketRecord *pp = (PacketRecord *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getOvhdBits());
        case 1: return long2string(pp->getUserBits());
        case 2: return bool2string(pp->getErrorFlag());
        case 3: return long2string(pp->getSequenceNumber());
        default: return "";
    }
}

bool PacketRecordDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketRecord *pp = (PacketRecord *)object; (void)pp;
    switch (field) {
        case 0: pp->setOvhdBits(string2long(value)); return true;
        case 1: pp->setUserBits(string2long(value)); return true;
        case 2: pp->setErrorFlag(string2bool(value)); return true;
